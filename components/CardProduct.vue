<template>
  <div>
    <div class="relative flex flex-col items-center justify-center hover:scale-105 transition duration-500 cursor-pointer" style="min-height: 42vh !important;">
      <div class="container">
        <div class="max-w-md w-full bg-neutral-100 shadow-md rounded-xl p-6">
              ...
              <div class="flex-auto justify-evenly">
                <div class="flex flex-wrap w-full">
                  ...
                  <div class="flex items-center w-full justify-between min-w-0">
                    ...
                    >
                      Rumah Minimalis dengan type 80
                    </h2>
                    <!-- <div
